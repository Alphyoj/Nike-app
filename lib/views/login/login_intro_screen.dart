...
class HiNikeSignIn extends StatefulWidget {
  const HiNikeSignIn({super.key});

  @override
  State<HiNikeSignIn> createState() => _HiNikeSignInState();
}

class _HiNikeSignInState extends State<HiNikeSignIn> {
  ...
  Future<bool> _isPhoneAlreadyUsed(String phone) async {
    try {
      final signInMethods =
          await _auth.fetchSignInMethodsForEmail('$phone@fake.com');
